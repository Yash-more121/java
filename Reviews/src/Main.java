public class Main {
    public static void main(String[] args) {
        ...
        p1.addReview(4.5f, "It has excellent features!", "Loved it!");
        ...
        p1.addReview(4.8f, "Amazing camera quality", "Nice look");
        ...
        p1.addReview(4.2f, "durable", "Amazing!");

        p1.addReview(5.0f, "Perfect phone in affordable price", "Fantastic product");
